...
int main(int argc,char **argv){
  ...
  SOFM(200, 0.5, 0.4 , 6, 5);
  Calibration();
  printf("\n\nResult after the first 200 iterations:\n");
  PrintResult();

  SOFM(200, 0.4, 0.3 , 5, 4);
  Calibration();
  printf("\n\nResult after the first 400 iterations:\n");
  PrintResult();

  SOFM(200, 0.3, 0.2 , 4, 3);
  Calibration();
  printf("\n\nResult after the first 600 iterations:\n");
  PrintResult();

  SOFM(200, 0.2, 0.1 , 3, 2);
  Calibration();
  printf("\n\nResult after the first 800 iterations:\n");
  PrintResult();

  SOFM(200, 0.1, 0 , 2, 1);
  Calibration();
  printf("\n\nResult after the first 1000 iterations:\n");
  PrintResult();
}
